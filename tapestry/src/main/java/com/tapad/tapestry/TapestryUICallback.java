...
public abstract class TapestryUICallback implements TapestryCallback {
    ...
    /**
     * @param activity An activity is required in order to access the {@code runOnUiThread} method
     */
     ...
     * @param response
     */
    public abstract void receiveOnUiThread(TapestryResponse response);
}
