 ...
 * <p/>
 * Examples of getting information from a response: <blockquote>
 * 
 * <pre>
...
public class TapestryResponse {
	...
	/**
	 * Returns information about each device separately as a list of responses. For instance, whereas
	 * {@code getPlatforms()} normally returns a list of platforms from all devices, calling {@code getPlatforms()} on a
	...
	/**
	 * Returns any errors that occurred when handling this request. The types of errors can be found in the
	 * {@link TapestryError} class.
	 * 
	 ...
	 * 
	 * @param key
	 *            The key to retrieve from devices
